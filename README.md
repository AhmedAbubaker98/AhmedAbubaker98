...
| [**GitInsight**](https://github.com/AhmedAbubaker98/GitInsight) | Python FastAPI · Redis · PostgreSQL · K8s · OpenAI | AI codebase intelligence: ingest any GitHub repo, surface architecture insights, dependency graphs, and natural-language explanations.|
